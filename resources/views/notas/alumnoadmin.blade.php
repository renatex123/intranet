            ...
            <div class="card">
                ...
                <div class="card-body"> 
                    ...
                    <div class="col-md-2">
                        ...
                        <div class="col-md-2">
                        <input  type="text" class="form-control{{ $errors->has('nota2') ? ' is-invalid' : '' }}" name="nota2"  value="{{ $nota->nota2 }}" maxlength="2" OnKeyUp="Sumar()" autocomplete="off">       @if ($errors->has('nota2'))
                                <span class="invalid-feedback" role="alert">
