         ...
         <select class="form-control" name="carrera_id">@forelse($carreras as $carrera)<option value="{{ $carrera->id }}">{{ $carrera->nombre }}</option>   @empty
            ...
            <select class="form-control" name="curso_id">@forelse($cursos as $curso)<option value="{{ $curso->id }}">{{ $curso->nombre }}</option>   @empty
                       ...
                       <div class="col-md-8">
                        ...
                        <div class="form-group row">
                            <label for="nombre" class="col-md-4 col-form-label text-md-right">{{ __('Nombre del Documento') }}</label>

                            <div class="col-md-8">
                                <input id="nombre" type="text" class="form-control{{ $errors->has('nombre') ? ' is-invalid' : '' }}" name="nombre" autocomplete="off" value="{{ $documentos->nombre }}">
